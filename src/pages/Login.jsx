...
export default function Login() {
  ...
  const [error, setError] = useState(searchParams.get('error') === 'oauth_failed' ? 'OAuth sign-in failed. Please try again.' : '');
        ...
        <div className="auth-card">
          ...
          <form onSubmit={handleSubmit} className="auth-form">
            ...
            <button 
              ...
              disabled={loading}
              style={{ marginTop: '1rem', backgroundColor: '#4b5563', border: '1px solid #6b7280' }}
            >
              Continue as Guest
            </button>
          </form>
          ...
          <div className="auth-encryption-badge">
            <Lock size={12} />
            <span>Protected by AES-256-GCM end-to-end encryption</span>
          </div>
        </div>
      </div>
    </div>
